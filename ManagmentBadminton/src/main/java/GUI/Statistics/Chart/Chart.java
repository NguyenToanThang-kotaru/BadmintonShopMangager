...
import GUI.Statistics.Chart.BlankChart.BlankPlotChart;
import GUI.Statistics.Chart.BlankChart.BlankPlotChatRender;
import GUI.Statistics.Chart.BlankChart.SeriesSize;
...
public class Chart extends javax.swing.JPanel {
    ...
    public Chart() {
        initComponents();
        setOpaque(false);
        animator = new Animator(800, fraction -> {
            animate = fraction;
            repaint();
        });
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(blankPlotChart, javax.swing.GroupLayout.DEFAULT_SIZE, 474, Short.MAX_VALUE)
                .addGap(0, 0, 0)
