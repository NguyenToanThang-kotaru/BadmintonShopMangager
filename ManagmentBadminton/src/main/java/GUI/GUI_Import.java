...
//                 selectedImport = new ImportInvoiceDTO(importID, employeeID, supplierID, String.valueOf(calculatedTotal), receiptDate);
...
//         List<ImportInvoiceDTO> importList = importBUS.getAllImport();
